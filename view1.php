...
<div align="center" color="purple"><b>Product List</b></div>
<?php
if(mysqli_num_rows($e1)>0)
{
echo"<table width='100%' border='1'>
<tr style='background-color:blue; text-color:white;'>
<th scope='row'><div align='center' class='style1'>id</div></th>
...
<td><div align='center' class='style1'>unit</div></td>
<td><div align='center' class='style1'>type</div></td>
</tr>";
